...
enum RouterVersion {
  EasyBakeRouter01 = 'EasyBakeRouter01',
  EasyBakeRouter02 = 'EasyBakeRouter02'
}

describe('EasyBakeRouter{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.EasyBakeRouter01]: fixture.router01,
        [RouterVersion.EasyBakeRouter02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.EasyBakeRouter01]: 101876,
              [RouterVersion.EasyBakeRouter02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETHForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.EasyBakeRouter01]: 138770,
              [RouterVersion.EasyBakeRouter02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
